  ...
  WebAudioTrack.prototype = {
    ...
    play: function() {
      ...
      this.gainNode.gain.setValueAtTime(
        this.volume,
        currentAudioContext.currentTime + 0.0001
      );
      ...
      mergeLeftRightBuffers(
        {
          ...
          rightBuffers:
            this.numberOfAudioChannels === 1 ? [] : this.rightChannel,
        },
        function(buffer, view) {
          ...
          this.audioData = this._decodeAudio(
            buffer,
            function() {
              callback && callback();
    ...
    appendAudioFromTrack: function(audioTrack) {
      ...
      var bufferNew = this.context.createBuffer(
        numberOfChannels,
    ...
    _setupProcessor: function() {
      var jsAudioNodeCreator = this.context.createJavaScriptNode
        ? "createJavaScriptNode"
        : "createScriptProcessor";
      this.jsAudioNode = this.context[jsAudioNodeCreator](
        this.bufferSize,
